...
import '../../App.css';
import { Image, Modal, Button, Card, OverlayTrigger, Popover } from 'react-bootstrap';
export default function Show(props) {
	...
	const allergyPopover = (
		<Popover id="popover-update">
			...
			<Popover.Content>Heads up! This recipe contains an ingredient you are allergic to.</Popover.Content>
		</Popover>
	);
	...
	function isAllergic() {
		let result = false;
		if (Array.isArray(props.recipe.extendedIngredients)) {
