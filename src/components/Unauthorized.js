  ...
  return (
    <div className="unauthorized-site container-fluid span12">
      ...
      <div className="middle row">
        ...
        <Jumbotron className="blurb">
          <p>
            PotLucky is the site you've been wishing for!
            <br />
            <br />
            Save ingredients you have at home and search for recipes using them.
            You can also search with text if you already have an idea of what
            you're looing for. But the fun doesn't stop there! Update your
            pantry after you complete a recipe, save recipes for later. You can
            even save allergies and we'll let you know if a recipe has that
            allergen.
            <br />
            <br />
